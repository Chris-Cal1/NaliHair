...
export default function RecipeDay1(props) {
  ...
  <ImageBackground source={require('../assets/007.png')} style={styles.container}>
   ...
   <View style={{ marginLeft: 25 }}>
        <Text style={{ fontSize: 20, color: 'black', margin: 10, fontFamily: 'Roboto_500Medium', }}>Shampoing clarifiant à l'argile verte </Text>
        <Image style={{ flex: 1, width: 360, height: '20%' }} source={recipeDay2Photo}/>
        <ScrollView>
        <Text style={{ fontSize: 24, color: 'black', marginTop: 20, marginBottom: 10, fontWeight: 'bold', fontFamily: 'Roboto_700Bold' }}>Bienfaits</Text>
        ...
        <Text style={{ fontSize: 20, color: 'black',  marginTop: 10, marginBottom: 10, fontFamily: 'Roboto_500Medium', }}>Ingrédients nécessaires</Text>
        <Text style={{ fontFamily: 'Roboto_400Regular', fontSize: 13}}>Argile verte, glycerine, miel, banane</Text>
        <Text style={{ fontSize: 20, color: 'black',  marginTop: 15, marginBottom: 10, fontFamily: 'Roboto_500Medium', }}>Mode d'emploi</Text>
        ...
        <View style={{ marginBottom: 15, marginRight: 15, marginTop: 15 ,flexDirection: 'row', alignItems: 'center'}}>
        <Text onPress={() => props.navigation.navigate( 'RecipeDay3' ) }
        style={{marginLeft: 140, fontSize: 20, color: 'black',  fontFamily: 'Roboto_500Medium', }}>Suivant</Text>
        <AntDesign 
